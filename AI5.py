...
def restaurant_chatbot():
    print("Welcome to the Ateeb's Restaurant!")
    ...
    while True:
        ...
        if "menu" in user_input:
            ...
            print("Chatbot: The average cost per person is around Rs.100.")
        
        elif "contact" in user_input or "phone" in user_input:
            print("Chatbot: You can contact us at +91-7709406413")
        
        elif "reservation" in user_input or "book" in user_input:
            print("Chatbot: To make a reservation, please call us at +91-7709406413 or visit our website at https://Ateebs.com")
